          ...
          <TableHead
            ...
            className={`${
              value == "vendor_id"
                ...
                : " justify-center"
            } !w-1/4 flex  !text-left   items-center gap-x-4   text-base    bg-[#fafafa] !text-gray-800      !border-none`}
          >
            <span>
              {label == "Vendor Name" && (
                <Checkbox
                  ...
                  checked={
                    !isLoading &&
                    formatCombineVendorsArray(data?.data)?.length !== 0 &&
      ...
      {isLoading ? (
        <div className="!w-full max-h-[60vh]">
          {new Array(15).fill(10)?.map((_, index) => (
            <TableRow
              className="flex w-full justify-between  border-none"
              key={index}
            >
              {["a", "b", "c", "d"]?.map((_, i) => {
                return (
                  <TableCell
                    ...
                    } flex  !text-left items-center justify-center border-none w-1/4 pb-4 !font-semibold !bg-transparent !min-w-40 border-b  `}
                  >
                    {" "}
            ...
            {data && Object?.keys(data?.["data"])?.length > 0
              ? formatCombineVendorsArray(data?.["data"])?.map(
                  ({
                    ...
                    <TableRow
                      key={vendor_id}
                      className="flex w-full justify-between border-none space-y-2 hover:bg-[#F4F4F4] cursor-pointer items-center"
                    >
