  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (e.key === "ArrowDown") {
        ...
        navigate(
          `/category-wise-items/${selectedItem?.category?.category_id}?category_name=${selectedItem?.category?.name}&mode=all`
        );
      }
    };
              ...
              {data?.data
                ...
                ?.map((item, index) => (
                  <TableRow
                    ...
                    onClick={() => {
                      navigate(
                        `/category-wise-items/${item?.category?.category_id}?category_name=${item?.category?.name}&mode=all`
                      );
                    }}
