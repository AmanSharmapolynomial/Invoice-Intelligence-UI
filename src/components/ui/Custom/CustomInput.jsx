            ...
            {type == "number" ? (
              <div className="flex items-center gap-x-0 border-[1px] border-[#E0E0E0] rounded-md pl-2">
                ...
                <div className="flex flex-col gap-y-0.5 ml-1 justify-between items-stretch">
                  <div
                    className="cursor-pointer flex justify-center !h-[1.1rem] w-[1.1rem] items-center bg-primary rounded-tr-md"
                    onClick={() => handleChange(parseInt(inputValue) + 1)}
                  >
                    <ChevronUp className="h-3 w-3 text-white" />
                  </div>
                  <div
                    className="cursor-pointer flex justify-center !h-[1.1rem] w-[1.1rem] items-center bg-primary rounded-br-md"
                    onClick={() => handleChange(parseInt(inputValue) - 1)}
                  >
